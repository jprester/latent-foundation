...
export default function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className="relative w-14 h-7 bg-gray-300 dark:bg-gray-600 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-scp-accent focus:ring-offset-2 dark:focus:ring-offset-gray-800"
